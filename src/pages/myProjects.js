...
export default function MyProjects() {
  return <div className="project-description">
    ...
    <div className="description-contents">
      ...
      <p>Between December 2020 and March 2021, I completed General Assembly's Software Development course - a full-time, immersive course that look place over 12 weeks. Find out more about my projects by clicking on the TV buttons below.</p>
