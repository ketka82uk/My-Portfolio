...
export default function ProjectFour() {
  return <div className="project-description">
    ...
    <div className="description-contents">
      ...
      <p>Final project for General Assembly Software Engineering Course. A group of three of us created Baggle, a modern bartering site. Baggle is a full-stack application using a Flask REST framework on a Python Flask API to serve data from a PostgreSQL database.</p>
