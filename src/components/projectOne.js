...
export default function ProjectOne() {
  return <div className="project-description">
    ...
    <p className="p-portfolio">The first project I completed as part of General Assembly's Software Engineering course in Jan 2021. Uses vanilla JS, HTML and CSS to create a 2D grid-based game.</p>
    <p className="p-portfolio" style={{ fontSize: '30px' }}><SiJavascript /> <SiHtml5 /> <SiCss3 /></p>
